...
st.markdown("""
    ...
    .control-center { background: rgba(23, 28, 36, 0.7); border-radius: 15px; padding: 2rem; border: 1px solid rgba(255, 255, 255, 0.1); backdrop-filter: blur(10px); margin-bottom: 2rem; }
    [data-testid="stMetric"] { background: rgba(30, 39, 53, 0.6); border: 1px solid rgba(255, 255, 255, 0.05); border-radius: 12px; padding: 15px !important; box-shadow: 0 4px 15px rgba(0,0,0,0.3); }
    ...
    .stTabs [data-baseweb="tab"] { height: 50px; white-space: pre-wrap; background-color: transparent; border-radius: 4px 4px 0px 0px; gap: 1px; padding-top: 10px; padding-bottom: 10px; color: #8b949e; }
    .stTabs [aria-selected="true"] { background-color: transparent; color: #58a6ff !important; border-bottom: 2px solid #58a6ff !important; }
...
@st.cache_data
def get_sim_results(config_dict):
